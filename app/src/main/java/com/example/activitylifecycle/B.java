...
public class B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activities.setButtonsBackground(findViewById(R.id.buttons), getResources().getColor(R.color.BButton));
    ...
    /**
     * Callback 函数，调用 Activity A
     * @param view 与函数绑定在一起的 View
     */
    public void startAByB(View view) {
        Intent intent = new Intent(this, A.class).putExtra(Activities.EXTRA_CALLER, ID);
     ...
     * @param view 与函数绑定在一起的 View
     */
    public void startCByB(View view) {
