...
public class C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activities.setButtonsBackground(findViewById(R.id.buttons), getResources().getColor(R.color.CButton));
     ...
     */
    public void startAByC(View view) {
     ...
     * @param view 与函数绑定在一起的 View
     */
    public void startBByC(View view) {
